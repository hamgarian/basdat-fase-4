<nav x-data="{ open: false }" class="bg-slate-950 border-b border-slate-800">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-slate-200 bg-slate-900 hover:bg-slate-800 hover:text-white focus:outline-none transition ease-in-out duration-150">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden bg-slate-950 sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-slate-800">
            <div class="px-4">
                ...
                <div class="font-medium text-sm text-slate-400">{{ Auth::user()->username }}</div>
            </div>
